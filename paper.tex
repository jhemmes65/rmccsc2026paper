...
\begin{figure*}[h]
\centering
\includegraphics[width=.75\textwidth]{classdiagrams.png}
\label{umlclass}
...
With a more methodical approach, this methodology also prevents one of the most common problems instructors face when covering design patterns: trying to cover too many.
